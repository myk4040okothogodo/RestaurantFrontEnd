  ...
  <div className="app__aboutus app__bg flex__center section_padding " id="about">
      ...
      <div className = "app__aboutus-content flex__center">
          <div className = "app__aboutus-content_about">
              ...
              <p className="p__opensans">Lorem ipsum dolor sit amet, cosncture adipiscing elit. Quis pharetra adipiscing ultrices vulputate posuere tristique. In sed odio nec aliquet eu proin mauris et. </p>
